# Markdown Inline Annotation Extension — v1 (Archived)

> **Archived.** This is the v1 syntax, implemented by `markdown-it-inline-annotation`
> `0.1.x` and `logseq-furigana-ruby` `0.5.x`. The current normative spec is
> [`../SPEC.md`](../SPEC.md) (v2). v2 is almost a superset of v1; see the
> "Changes from v1" section there and [`v2-rationale.md`](./v2-rationale.md).
